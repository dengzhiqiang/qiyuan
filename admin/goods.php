...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    // =======================
    $allow_rank_id = empty($_POST['allow_rank_id']) ? '' : intval($_POST['allow_rank_id']);
    /* 入库 */
    if ($is_insert)
    {
        if ($code == '')
        {
            ...
            $sql = "INSERT INTO " . $ecs->table('goods') . " (allow_rank_id,goods_name, goods_name_style, goods_sn, " .
                ...
                "VALUES ('$allow_rank_id','$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
