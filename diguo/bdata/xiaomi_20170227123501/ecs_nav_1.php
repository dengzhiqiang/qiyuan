...
E_D("replace into `ecs_nav` values('32','c','101','报名须知','1','3','0','category.php?id=101','middle');");
E_D("replace into `ecs_nav` values('23','','0','报价单','0','6','0','quotation.php','top');");
E_D("replace into `ecs_nav` values('42','c','76','活动列表','1','1','0','category.php?id=76','middle');");
E_D("replace into `ecs_nav` values('43','c','69','活动预报','1','2','0','category.php?id=69','middle');");
...
E_D("replace into `ecs_nav` values('44','c','108','联系我们','1','4','0','category.php?id=108','middle');");
E_D("replace into `ecs_nav` values('45','c','118','团体报名','1','5','0','category.php?id=118','middle');");
