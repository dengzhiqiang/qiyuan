...
E_D("replace into `ecs_pay_log` values('76','47','568.00','0','0');");
E_D("replace into `ecs_pay_log` values('77','48','104.00','0','0');");
E_D("replace into `ecs_pay_log` values('78','49','914.00','0','0');");
E_D("replace into `ecs_pay_log` values('79','50','2214.00','0','0');");
E_D("replace into `ecs_pay_log` values('80','51','1314.00','0','0');");
