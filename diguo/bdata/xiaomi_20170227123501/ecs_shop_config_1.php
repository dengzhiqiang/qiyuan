...
E_D("replace into `ecs_shop_config` values('115','1','service_phone','text','','','010-65128228','1');");
...
E_D("replace into `ecs_shop_config` values('330','3','search_keywords','text','','','活动的关键字1,活动的关键字2','0');");
...
E_D("replace into `ecs_shop_config` values('910','8','sms_ecmoban_user','text','','','admin','0');");
E_D("replace into `ecs_shop_config` values('911','8','sms_ecmoban_password','password','','','admin2016','0');");
