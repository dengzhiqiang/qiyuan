...
function timeOutDengStr(){
    echo '<meta charset="utf-8">';
    echo '<h1 style="text-align: center;font-size: 18px;">操作频率过快</h1>';
    echo '<h3 style="text-align: center;font-size: 20px;"><b id="timeOutDeng" style="color:#bb0000;">3</b>秒后进行下一步操作！</h3>';
    echo '<script>';
    echo '   var timeOutDeng = document.getElementById("timeOutDeng");' ;
    echo '   var __timeOutDeng = 3;' ;
    echo '    var timeoutTimer = setInterval(function () {';
    echo '        if (__timeOutDeng === 0) {';
    echo '            clearInterval(timeoutTimer);';
    echo '            window.location.reload();';
    echo '        }';
    echo '        timeOutDeng.innerHTML = __timeOutDeng--;';
    echo '    }, 1000);';
    echo '</script>';
}
