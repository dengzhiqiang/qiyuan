...
//                        file_put_contents(ROOT_PATH . '1.txt',$good_id );
                ...
                $post_data = "account=C40765872&password=d036e63774a2b972bb0931d972691888&mobile=".$mobile."&content=".rawurlencode("提醒您，您已成功报名“".$mobile_code."”，您的订单号是“". $order_id ."”，请及时参加活动。");
