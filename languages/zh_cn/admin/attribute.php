...
/* 列表 */
$_LANG['by_goods_type'] = '按活动类型显示：';
$_LANG['all_goods_type'] = '所有活动类型';
...
$_LANG['attr_type'] = '购买活动时是否需要选择该属性的值';
...
$_LANG['label_cat_id'] = '所属活动类型：';
$_LANG['label_attr_index'] = '能否进行检索：';
$_LANG['label_is_linked'] = '相同属性值的活动是否关联？';
$_LANG['no_index'] = '不需要检索';
$_LANG['keywords_index'] = '关键字检索';
$_LANG['range_index'] = '范围检索';
$_LANG['note_attr_index'] = '不需要该属性成为检索活动条件的情况请选择不需要检索，需要该属性进行关键字检索活动时选择关键字检索，如果该属性检索时希望是指定某个范围时，选择范围检索。';
...
$_LANG['note_attr_type'] = '选择"单选/复选属性"时，可以对活动该属性设置多个值，同时还能对不同属性值指定不同的价格加价，用户购买活动时需要选定具体的属性值。选择"唯一属性"时，活动的该属性值只能设置一个值，用户只能查看该值。';
