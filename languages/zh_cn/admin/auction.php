...
$_LANG['notice_act_name'] = '如果留空，取拍卖活动的名称（该名称仅用于后台，前台不会显示）';
$_LANG['label_act_desc'] = '拍卖活动描述：';
$_LANG['label_search_goods'] = '根据活动编号、名称或货号搜索活动';
$_LANG['label_goods_name'] = '拍卖活动名称：';
...
$_LANG['pls_search_goods'] = '请先搜索活动';
$_LANG['search_result_empty'] = '没有找到活动，请重新搜索';

$_LANG['pls_select_goods'] = '请选择拍卖活动';
$_LANG['goods_not_exist'] = '您要拍卖的活动不存在';
