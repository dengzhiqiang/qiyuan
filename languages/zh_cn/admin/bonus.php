...
$_LANG['notice_min_goods_amount'] = '只有活动总金额达到这个数的订单才能使用这种红包';
...
$_LANG['send_by'][SEND_BY_GOODS] = '按活动发放';
...
$_LANG['goods_cat'] = '选择活动分类';
$_LANG['goods_brand'] = '活动品牌';
$_LANG['goods_key'] = '活动关键字';
$_LANG['all_goods'] = '可选活动';
$_LANG['send_bouns_goods'] = '发放此类型红包的活动';
$_LANG['remove_bouns'] = '移除红包';
$_LANG['all_remove_bouns'] = '全部移除';
$_LANG['goods_already_bouns'] = '该活动已经发放过其它类型的红包了!';
