...
$_LANG['category_edit'] = '编辑活动分类';
$_LANG['move_goods'] = '转移活动';
$_LANG['cat_top'] = '顶级分类';
$_LANG['show_in_nav'] = '是否显示在导航栏';
$_LANG['cat_style'] = '分类的样式表文件';
$_LANG['is_show'] = '是否显示';
$_LANG['show_in_index'] = '设置为首页推荐';
$_LANG['notice_show_in_index'] = '该设置可以在首页的最新、热门、推荐处显示该分类下的推荐活动';
$_LANG['goods_number'] = '活动数量';
$_LANG['grade'] = '价格区间个数';
$_LANG['notice_grade'] = '该选项表示该分类下活动最低价与最高价之间的划分的等级个数，填0表示不做分级，最多不能超过10个。';
...
$_LANG['notice_style'] = '您可以为每一个活动分类指定一个样式表文件。例如文件存放在 themes 目录下则输入：themes/style.css';

/* 操作提示信息 */
$_LANG['catname_empty'] = '分类名称不能为空!';
$_LANG['catname_exist'] = '已存在相同的分类名称!';
$_LANG["parent_isleaf"] = '所选分类不能是末级分类!';
$_LANG["cat_isleaf"] = '不是末级分类或者此分类下还存在有活动,您不能删除!';
$_LANG["cat_noleaf"] = '底下还有其它子分类,不能修改为末级分类!';
$_LANG["is_leaf_error"] = '所选择的上级分类不能是当前分类或者当前分类的下级分类!';
$_LANG['grade_error'] = '价格分级数量只能是0-10之内的整数';

$_LANG['catadd_succed'] = '新活动分类添加成功!';
$_LANG['catedit_succed'] = '活动分类编辑成功!';
$_LANG['catdrop_succed'] = '活动分类删除成功!';
$_LANG['catremove_succed'] = '活动分类转移成功!';
$_LANG['move_cat_success'] = '转移活动分类已成功完成!';

$_LANG['cat_move_desc'] = '什么是转移活动分类?';
...
$_LANG['cat_move_notic'] = '在添加活动或者在活动管理中,如果需要对活动的分类进行变更,那么你可以通过此功能,正确管理你的活动分类。';

$_LANG['cat_move_empty'] = '你没有正确选择活动分类!';

$_LANG['sel_goods_type'] = '请选择活动类型';
$_LANG['sel_filter_attr'] = '请选择筛选属性';
$_LANG['filter_attr'] = '筛选属性';
$_LANG['filter_attr_notic'] = '筛选属性可在前分类页面筛选活动';
