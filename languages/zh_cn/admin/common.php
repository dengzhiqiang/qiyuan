...
/* 活动管理 */
$_LANG['01_goods_list'] = '活动列表';
$_LANG['02_goods_add'] = '添加新活动';
$_LANG['03_category_list'] = '活动分类';
$_LANG['04_category_add'] = '添加分类';
$_LANG['05_comment_manage'] = '用户评论';
$_LANG['06_goods_brand_list'] = '活动品牌';
$_LANG['07_brand_add'] = '添加品牌';
$_LANG['08_goods_type'] = '活动类型';
$_LANG['09_attribute_list'] = '活动属性';
$_LANG['10_attribute_add'] = '添加属性';
$_LANG['11_goods_trash'] = '活动回收站';
$_LANG['12_batch_pic'] = '图片批量处理';
$_LANG['13_batch_add'] = '活动批量上传';
$_LANG['15_batch_edit'] = '活动批量修改';
$_LANG['16_goods_script'] = '生成活动代码';
$_LANG['17_tag_manage'] = '标签管理';
$_LANG['18_product_list'] = '货品列表';
$_LANG['52_attribute_add'] = '编辑属性';
$_LANG['53_suppliers_goods'] = '供货商活动管理';

$_LANG['14_goods_export'] = '活动批量导出';

$_LANG['50_virtual_card_list'] = '虚拟活动列表';
$_LANG['51_virtual_card_add'] = '添加虚拟活动';
$_LANG['52_virtual_card_change'] = '更改加密串';
$_LANG['goods_auto'] = '活动自动上下架';
...
/* 积分兑换管理 */
$_LANG['15_exchange_goods'] = '积分商城活动';
$_LANG['15_exchange_goods_list'] = '积分商城活动列表';
$_LANG['exchange_goods_add'] = '添加新活动';
