 ...
 */
$_LANG['label_category'] = '选择活动分类：';
$_LANG['label_brand'] = '选择活动品牌：';
...
$_LANG['js_languages']['goods_num_must_be_int'] = '活动数量应该是整数';
$_LANG['js_languages']['goods_num_must_over_0'] = '活动数量应该大于0';
