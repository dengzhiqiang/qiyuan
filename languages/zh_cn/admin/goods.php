...
$_LANG['lab_is_free_shipping'] = '是否为免运费活动';

$_LANG['compute_by_mp'] = '按市场价计算';

$_LANG['notice_goods_sn'] = '如果您不输入活动货号，系统将自动生成一个唯一的货号。';
$_LANG['notice_integral'] = '(此处需填写金额)购买该活动时最多可以使用积分的金额';
...
$_LANG['notice_storage'] = '库存在活动为虚货或活动存在货品时为不可编辑状态，库存数值取决于其虚货数量或货品数量';
...
$_LANG['free_shipping'] = '打勾表示此活动不会产生运费花销，否则按照正常运费计算。';
...
$_LANG['suppliers_no']             = '不指定供货商属于本店活动';
...
$_LANG['products_title'] = '活动名称：%s';
$_LANG['products_title_2'] = '货号：%s';
$_LANG['good_shop_price'] = '（活动价格：%d）';
$_LANG['good_goods_sn'] = '（活动货号：%s）';
...
$_LANG['cannot_goods_number'] = '此活动存在货品，不能修改活动库存';
$_LANG['not_exist_goods_attr'] = '此活动不存在规格，请为其添加规格';
$_LANG['goods_sn_exists'] = '您输入的货号已存在，请换一个';
?>