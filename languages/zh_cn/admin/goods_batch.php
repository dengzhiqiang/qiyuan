...
$_LANG['select_method'] = '选择活动的方式：';
$_LANG['by_cat'] = '根据活动分类、品牌';
$_LANG['by_sn'] = '根据活动货号';
$_LANG['select_cat'] = '选择活动分类：';
$_LANG['select_brand'] = '选择活动品牌：';
$_LANG['goods_list'] = '活动列表：';
$_LANG['src_list'] = '待选列表：';
$_LANG['dest_list'] = '选定列表：';
$_LANG['input_sn'] = '输入活动货号：<br />（每行一个）';
...
$_LANG['goods_class'] = '活动类别';
$_LANG['g_class'][G_REAL] = '实体活动';
...
$_LANG['notice_file'] = '（CSV文件中一次上传活动数量最好不要超过1000，CSV文件大小最好不要超过500K.）';
...
$_LANG['use_help'] = '使用说明：' .
        '<ol>' .
          ...
          '<li>填写csv文件，可以使用excel或文本编辑器打开csv文件；<br />' .
              ...
              '活动图片和活动缩略图请填写带路径的图片文件名，其中路径是相对于 [根目录]/images/ 的路径，例如图片路径为[根目录]/images/200610/abc.jpg，只要填写 200610/abc.jpg 即可；<br />' .
               '<font style="color:#FE596A;">如果是淘宝助理格式请确保cvs编码为在网站的编码，如编码不正确，可以用编辑软件转换编码。</font></li>' .
          '<li>将填写的活动图片和活动缩略图上传到相应目录，例如：[根目录]/images/200610/；<br />'.
              '<font style="color:#FE596A;">请首先上传活动图片和活动缩略图再上传csv文件，否则图片无法处理。</font></li>' .
          '<li>选择所上传活动的分类以及文件编码，上传csv文件</li>' .
        '</ol>';

$_LANG['js_languages']['please_select_goods'] = '请您选择活动';
$_LANG['js_languages']['please_input_sn'] = '请您输入活动货号';
...
// 批量上传活动的字段
$_LANG['upload_goods']['goods_name'] = '活动名称';
$_LANG['upload_goods']['goods_sn'] = '活动货号';
$_LANG['upload_goods']['brand_name'] = '活动品牌';   // 需要转换成brand_id
$_LANG['upload_goods']['market_price'] = '市场售价';
$_LANG['upload_goods']['shop_price'] = '本店售价';
$_LANG['upload_goods']['integral'] = '积分购买额度';
$_LANG['upload_goods']['original_img'] = '活动原始图';
$_LANG['upload_goods']['goods_img'] = '活动图片';
$_LANG['upload_goods']['goods_thumb'] = '活动缩略图';
$_LANG['upload_goods']['keywords'] = '活动关键词';
$_LANG['upload_goods']['goods_brief'] = '简单描述';
$_LANG['upload_goods']['goods_desc'] = '详细描述';
$_LANG['upload_goods']['goods_weight'] = '活动重量（kg）';
...
$_LANG['upload_goods']['is_alone_sale'] = '能否作为普通活动销售';
$_LANG['upload_goods']['is_real'] = '是否实体活动';
