...
$_LANG['user_guide'] =
        '<br/>使用说明：' .
        '<ol>' .
          '<li>使用搜索条件每次只允许搜索符合条件的50个活动。</li>' .
          '<li>如果用户需要导出某分类下的所有的活动，在条件中选择分类后，不需点击搜索，直接选择数据格式和编码导出即可。</li>' .
        '</ol>';
...
$_LANG['taobao46']['sellers_code'] = '系统编码';
...
$_LANG['paipai4']['id'] = 'id';
$_LANG['paipai4']['goods_name'] = '活动名称';
$_LANG['paipai4']['auctionType'] = '出售方式';
$_LANG['paipai4']['category'] = '活动类目';
$_LANG['paipai4']['shopCategoryId'] = '店铺类目';
$_LANG['paipai4']['quantity'] = '活动数量';
...
$_LANG['paipai4']['description'] = '活动详情';
...
$_LANG['ecshop']['goods_name'] = '活动名称';
$_LANG['ecshop']['goods_sn'] = '活动货号';
$_LANG['ecshop']['brand_name'] = '活动品牌';   // 需要转换成brand_id
$_LANG['ecshop']['market_price'] = '市场售价';
$_LANG['ecshop']['shop_price'] = '本店售价';
$_LANG['ecshop']['integral'] = '积分购买额度';
$_LANG['ecshop']['original_img'] = '活动原始图';
$_LANG['ecshop']['goods_img'] = '活动图片';
$_LANG['ecshop']['goods_thumb'] = '活动缩略图';
$_LANG['ecshop']['keywords'] = '活动关键词';
$_LANG['ecshop']['goods_brief'] = '简单描述';
$_LANG['ecshop']['goods_desc'] = '详细描述';
$_LANG['ecshop']['goods_weight'] = '活动重量（kg）';
...
$_LANG['ecshop']['is_alone_sale'] = '能否作为普通活动销售';
$_LANG['ecshop']['is_real'] = '是否实体活动';

//自定义导出数据格式
$_LANG['export_custom'] = '导出到自定义数据格式';
$_LANG['custom']['goods_name'] = '活动名称';
$_LANG['custom']['goods_sn'] = '活动货号';
$_LANG['custom']['brand_name'] = '活动品牌';
$_LANG['custom']['market_price'] = '市场售价';
$_LANG['custom']['shop_price'] = '本店售价';
$_LANG['custom']['integral'] = '积分购买额度';
$_LANG['custom']['original_img'] = '活动原始图';
$_LANG['custom']['goods_img'] = '活动图片';
$_LANG['custom']['goods_thumb'] = '活动缩略图';
$_LANG['custom']['keywords'] = '活动关键词';
$_LANG['custom']['goods_brief'] = '简单描述';
$_LANG['custom']['goods_desc'] = '详细描述';
$_LANG['custom']['goods_weight'] = '活动重量（kg）';
...
$_LANG['custom']['is_alone_sale'] = '能否作为普通活动销售';
$_LANG['custom']['is_real'] = '是否实体活动';

$_LANG['custom_keyword'] = '关键字';
$_LANG['custom_goods_cat'] = '所有分类';
$_LANG['custom_goods_brand'] = '所有品牌';
$_LANG['custom_goods_list'] = '选择活动数据列';
$_LANG['custom_goods_type'] = '所有活动类型';
$_LANG['custom_export_list'] = '输出活动数据列';
$_LANG['custom_up'] = '上';
$_LANG['custom_down'] = '下';
$_LANG['custom_goods_search'] = '导出条件';
$_LANG['custom_goods_field_not_null'] = '输出的活动数据列不能为空';

// 导出条件
$_LANG['export_condition'] = '活动数据批量导出';
