...
$_LANG['label_goods_qty'] = '活动数 / 有效活动数：';
...
/* 添加/编辑活动提交 */
$_LANG['error_goods_null'] = '您没有选择团购活动！';
$_LANG['error_goods_exist'] = '您选择的活动目前有一个团购活动正在进行！';
$_LANG['error_price_ladder'] = '您没有输入有效的价格阶梯！';
$_LANG['error_restrict_amount'] = '限购数量不能小于价格阶梯中的最大数量';

$_LANG['js_languages']['error_goods_null'] = '您没有选择团购活动！';
...
$_LANG['js_languages']['search_is_null'] = '没有搜索到任何活动，请重新搜索';
...
/* 操作日志 */
$_LANG['log_action']['group_buy'] = '团购活动';
