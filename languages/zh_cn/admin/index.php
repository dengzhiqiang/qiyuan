...
$_LANG['goods_stat'] = '实体活动统计信息';
$_LANG['virtual_card_stat'] = '虚拟卡活动统计';
$_LANG['goods_count'] = '活动总数:';
$_LANG['sales_count'] = '促销活动数:';
$_LANG['new_goods'] = '新品推荐数:';
$_LANG['recommed_goods'] = '精品推荐数:';
$_LANG['hot_goods'] = '热销活动数:';
$_LANG['warn_goods'] = '库存警告活动数:';
...
$_LANG['images_cannt_write']= '您将无法上传任何活动图片。';
...
$_LANG['shop_closed_tips'] = '您的系统已被暂时关闭。在设置好您的系统之后别忘记打开哦！';
...
//开店向导
$_LANG['shop_name'] = '系统名称';
$_LANG['shop_title'] = '系统标题';
...
$_LANG['good_name'] = '活动名称';
$_LANG['good_number'] = '活动数量';
$_LANG['good_category'] = '活动分类';
$_LANG['good_brand'] = '活动品牌';
$_LANG['good_price'] = '活动价格';
$_LANG['good_brief'] = '活动描述';
$_LANG['good_image'] = '上传活动图片';
$_LANG['is_new'] = '新品';
$_LANG['is_best'] = '精品';
$_LANG['is_hot'] = '热卖';
...
$_LANG['skip'] = '完成向导';
$_LANG['next_step'] = '下一步';
$_LANG['ur_add'] = '开店向导－添加活动';
$_LANG['ur_config'] = '开店向导－设置网店';
$_LANG['shop_basic_first'] = "设置系统的一些基本信息<em>系统的名字、地址、配送方式、支付方式等</em>";
$_LANG['shop_basic_second'] = "给系统添加一些活动<em>活动的名称、数量、分类、品牌、价格、描述等</em>";
$_LANG['shop_basic_third'] = "恭喜您，您的网店可以使用了！<em>下面是一些常用功能的链接聚合。您关闭本页后，依然可以在左侧菜单相关项目中找到</em>";
$_LANG['add_good'] = '添加活动';
$_LANG['add_category'] = '添加活动分类';
$_LANG['add_type'] = '活动类型';
$_LANG['add_favourable'] = '添加优惠活动';
$_LANG['shop_config'] = '系统设置';
...
//JS语言
$_LANG['js_languages']['shop_name_not_null'] = '系统名称不能为空';
$_LANG['js_languages']['good_name_not_null'] = '活动名称不能为空';
$_LANG['js_languages']['good_category_not_null'] = '活动分类不能为空';
$_LANG['js_languages']['good_number_not_number'] = '活动数量不是数值';
$_LANG['js_languages']['good_price_not_number'] = '活动价格不是数值';
