...
$_LANG['log_action']['category'] = '活动分类';
$_LANG['log_action']['pack'] = '活动包装';
$_LANG['log_action']['card'] = '活动贺卡';
...
$_LANG['log_action']['goods_type'] = '活动类型';
$_LANG['log_action']['booking'] = '缺货登记管理';
$_LANG['log_action']['tag_manage'] = '标签管理';
$_LANG['log_action']['shop_config'] = '系统设置';
...
$_LANG['log_action']['exchange_goods'] = '积分可兑换的活动';
