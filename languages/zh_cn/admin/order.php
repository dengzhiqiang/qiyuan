...
$_LANG['notice_cancel_note'] = '（会记录在系统给客户的留言中）';
$_LANG['op_confirm'] = '确认';
$_LANG['op_pay'] = '付款';
$_LANG['op_prepare'] = '配货';
$_LANG['op_ship'] = '发货';
...
$_LANG['op_receive'] = '个人信息';
$_LANG['op_assign'] = '指派给';
$_LANG['op_after_service'] = '售后';
$_LANG['act_ok'] = '操作成功';
$_LANG['act_false'] = '操作失败';
$_LANG['act_ship_num'] = '此单发货数量不能超出订单活动数量';
$_LANG['act_good_vacancy'] = '活动已缺货';
...
$_LANG['phone'] = '电话';
$_LANG['group_buy'] = '（团购）';
$_LANG['error_get_goods_info'] = '获取订单活动信息错误';
...
$_LANG['label_consignee_address'] = '个人信息：';
...
$_LANG['label_postscript'] = '客户给系统的留言：';
...
$_LANG['goods_info'] = '活动信息';
$_LANG['goods_name'] = '活动名称';
$_LANG['goods_name_brand'] = '活动名称 [ 品牌 ]';
$_LANG['goods_sn'] = '货号';
...
$_LANG['label_total_weight'] = '活动总重量：';

$_LANG['label_goods_amount'] = '活动总金额：';
...
$_LANG['label_money_dues'] = '应缴纳报名费：';
$_LANG['label_money_refund'] = '应退款金额：';
$_LANG['label_to_buyer'] = '系统给客户的留言：';
...
$_LANG['step']['goods'] = '选择活动';
$_LANG['step']['consignee'] = '设置个人信息';
...
$_LANG['js_languages']['confirm_drop'] = '确认要删除该活动吗？';
$_LANG['js_languages']['invalid_goods_number'] = '活动数量不正确';
$_LANG['js_languages']['pls_search_goods'] = '请搜索并选择活动';
