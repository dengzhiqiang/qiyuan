...
$_LANG['notes'] = "图片批量处理允许您重新生成活动的缩略图以及重新添加水印。<br />该处理过程可能会比较慢，请您耐心等候。";
$_LANG['change_link'] = '为处理后图片生成新链接';
$_LANG['yes_change'] = '新生成图片使用新名称，并删除旧图片';
$_LANG['do_album'] = '处理活动相册';
$_LANG['do_icon'] = '处理活动图片';
$_LANG['all_goods'] = '所有活动';
$_LANG['action_notice'] = '请选上“处理活动相册”或“处理活动图片”';
$_LANG['no_change'] = '新生成图片覆盖旧图片';
$_LANG['thumb'] = '重新生成缩略图';
$_LANG['watermark'] = '重新生成活动详情图';
$_LANG['page'] = '页数';
$_LANG['total'] = '总页数';
$_LANG['time'] = '处理时间';
$_LANG['wait'] = '正在处理.....';
...
$_LANG['goods_format'] = '活动图片共 %d 张，每页处理 %d 张';
$_LANG['gallery_format'] = '活动相册图片共 %d 张，每页处理 %d 张';

$_LANG['done'] = '图片批量处理成功';
$_LANG['error_pos'] = '在处理活动ID为 %s 的活动图片时发生以下错误：';
