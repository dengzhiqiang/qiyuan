...
//活动管理部分的权限
$_LANG['goods_manage'] = '活动添加/编辑';
$_LANG['remove_back'] = '活动删除/恢复';
$_LANG['cat_manage'] = '分类添加/编辑';
$_LANG['cat_drop'] = '分类转移/删除';
$_LANG['attr_manage'] = '活动属性管理';
$_LANG['brand_manage'] = '活动品牌管理';
...
$_LANG['goods_export'] = '活动批量导出';
$_LANG['goods_batch'] = '活动批量上传/修改';
$_LANG['gen_goods_script'] = '生成活动代码';
$_LANG['suppliers_goods'] = '供货商活动管理';
