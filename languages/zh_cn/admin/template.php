...
$_LANG['template_files']['category_top'] = '活动顶级分类页模板';
$_LANG['template_files']['category'] = '活动分类页模板';
$_LANG['template_files']['flow'] = '购物流程模板';
$_LANG['template_files']['goods'] = '活动详情模板';
$_LANG['template_files']['group_buy_goods'] = '团购活动详情模板';
$_LANG['template_files']['group_buy_list'] = '团购活动列表模板';
$_LANG['template_files']['index'] = '首页模板';
$_LANG['template_files']['search'] = '活动搜索模板';
$_LANG['template_files']['compare'] = '活动比较模板';
$_LANG['template_files']['snatch'] = '夺宝奇兵';
$_LANG['template_files']['tag_cloud'] = '标签云模板';
$_LANG['template_files']['brand'] = '活动品牌页';
...
$_LANG['template_libs']['goods_attrlinked'] = '属性关联的活动';
$_LANG['template_libs']['recommend_best'] = '精品推荐';
$_LANG['template_libs']['recommend_promotion'] = '促销活动';
$_LANG['template_libs']['recommend_hot'] = '热卖活动';
$_LANG['template_libs']['recommend_new'] = '新品上架';
$_LANG['template_libs']['bought_goods'] = '购买过此活动的人还买过的活动';
$_LANG['template_libs']['bought_note_guide'] = '购买记录';
$_LANG['template_libs']['brand_goods'] = '品牌的活动';
$_LANG['template_libs']['brands'] = '品牌专区';
$_LANG['template_libs']['cart'] = '购物车';
$_LANG['template_libs']['cat_goods'] = '分类下的活动';
$_LANG['template_libs']['category_tree'] = '活动分类树';
$_LANG['template_libs']['comments'] = '用户评论列表';
$_LANG['template_libs']['consignee'] = '个人信息表单';
$_LANG['template_libs']['goods_fittings'] = '相关配件';
$_LANG['template_libs']['page_footer'] = '页脚';
$_LANG['template_libs']['goods_gallery'] = '活动相册';
$_LANG['template_libs']['goods_article'] = '相关文章';
$_LANG['template_libs']['goods_list'] = '活动列表';
$_LANG['template_libs']['goods_tags'] = '活动标记';
$_LANG['template_libs']['group_buy'] = '团购活动';
$_LANG['template_libs']['group_buy_fee'] = '团购活动费用总计';
$_LANG['template_libs']['help'] = '帮助内容';
$_LANG['template_libs']['history'] = '活动浏览历史';
...
$_LANG['template_libs']['goods_related'] = '相关活动';
...
$_LANG['template_libs']['auction'] = '拍卖活动';
...
$_LANG['template_libs']['categorys'] = '活动分类';
...
$_LANG['template_libs']['exchange_hot'] = '积分商城热卖活动';
$_LANG['template_libs']['exchange_list'] = '积分商城列表活动';
