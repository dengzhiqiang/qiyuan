...
$_LANG['js_languages']['move_item_confirm'] = '已选活动已经转移到\"className\"分类下';
$_LANG['js_languages']['item_upper_limit'] = '每个分类下的活动不能超过50个';
...
$_LANG['lable_title_upload'] = '活动分类标题图片';
