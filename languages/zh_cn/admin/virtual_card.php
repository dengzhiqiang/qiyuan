...
//-- 卡片信息
/*------------------------------------------------------ */
$_LANG['virtual_card_list'] = '虚拟活动列表';
...
/* 提示信息 */
$_LANG['replenish_no_goods_id'] = '缺少活动ID参数，无法进行补货操作';
$_LANG['replenish_no_get_goods_name'] = '活动ID参数有误，无法获取活动名';
