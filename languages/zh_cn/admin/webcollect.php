...
$_LANG['webcollect_notice'] = 'ECShop营销推广服务--网罗天下致力于帮网商寻找多渠道的推广途径，使之成本最低化，利益最大化。<br />对有固定消费群体的购物搜索、比较购物类网站进行资源整合，实现网商活动信息同时被多家购物搜索、比较购物类网站收录，并且实时互通。增加网商的网站曝光度以及提升网站的销售量等效果。';
...
$_LANG['col_goods_num'] = '个活动';
$_LANG['item'] = '条';

/* JS提示 */
$_LANG['js_languages']['sev_stop'] = '暂停服务后，您的系统、活动信息将停止向搜索引擎更新，确定要暂停吗？';
