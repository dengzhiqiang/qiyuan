...
$_LANG['save_wholesale_falid'] = '部分规格活动在活动“%s”的货品表中不存在，无法全部保存';
...
/* info */
$_LANG['label_search_goods'] = '活动编号、名称或货号';
$_LANG['label_goods_name'] = '批发活动名称：';
$_LANG['label_rank_name'] = '适用会员等级：';
$_LANG['label_enabled'] = '是否启用：';
$_LANG['js_languages']['pls_search_goods'] = '请搜索并选择批发活动';
...
$_LANG['user_rank_exist'] = '已经存在该活动针对您选择的会员等级的批发方案了';
