...
$_LANG['sys_msg'] = '系统提示';
$_LANG['catalog'] = '目录';
$_LANG['please_view_order_detail'] = '活动已发货，详情请到用户中心订单详情查看';
...
$_LANG['cart_info'] = '您的购物车中有 %d 件活动，总计金额 %s。';
$_LANG['shopping_and_other'] = '购买过此活动的人还购买过';
$_LANG['bought_notes'] = '购买记录';
$_LANG['later_bought_amounts'] = '近期成交数量';
$_LANG['bought_time'] = '购买时间';
$_LANG['turnover'] = '成交';
$_LANG['no_notes'] = '还没有人购买过此活动';
$_LANG['shop_price'] = "报名费";
$_LANG['market_price'] = "专柜价";
$_LANG['goods_brief'] = '活动描述：';
$_LANG['goods_album'] = '活动相册';
$_LANG['promote_price'] = "促销价";
$_LANG['fittings_price'] = "配件价格：";
$_LANG['collect'] = '加入收藏夹';
$_LANG['add_to_cart'] = '加入购物车';
$_LANG['return_to_cart'] = '放回购物车';
$_LANG['search_goods'] = '活动搜索';
$_LANG['search'] = '搜索';
$_LANG['wholesale_search'] = '搜索批发活动';
...
$_LANG['kilogram'] = '千克';
$_LANG['goods_sn'] = "活动货号";
$_LANG['goods_brand'] = "活动品牌";
$_LANG['goods_weight'] = "活动重量";
$_LANG['goods_number'] = "活动库存";
$_LANG['goods_give_integral'] = "此活动赠送：";
$_LANG['goods_integral'] = "此活动可使用：";
$_LANG['goods_bonus'] = "此活动可获得红包：";
$_LANG['goods_free_shipping'] = '此活动为免运费活动，计算配送金额时将不计入配送费用';
$_LANG['goods_rank'] = "用户评价：";
$_LANG['goods_compare'] = '活动比较';
$_LANG['properties'] = '活动属性：';
$_LANG['brief'] = '简要介绍：';
$_LANG['add_time'] = '上架时间：';
...
$_LANG['minute'] = '分钟';
$_LANG['compare'] = '比较';
$_LANG['volume_price'] = "购买活动达到以下数量区间时可享受的优惠价格";
$_LANG['number_to'] = '数量';
$_LANG['article_list'] = '文章列表';


/* 活动比较JS语言项 */
$_LANG['compare_js']['button_compare'] = '比较选定活动';
$_LANG['compare_js']['exist'] = '您已经选择了%s';
$_LANG['compare_js']['count_limit'] = '最多只能选择4个活动进行对比';
$_LANG['compare_js']['goods_type_different'] = '\"%s\"和已选择活动类型不同无法进行对比';
...
$_LANG['collect_existed'] = '该活动已经存在于您的收藏夹中。';
$_LANG['collect_success'] = '该活动已经成功地加入了您的收藏夹。';
$_LANG['copyright'] = "&copy; 2005-%s %s 版权所有，并保留所有权利。";
$_LANG['no_ads_id'] = '没有指定广告的ID以及跳转的URL地址!';
$_LANG['remove_collection_confirm'] = '您确定要从收藏夹中删除选定的活动吗？';
$_LANG['err_change_attr'] = '没有找到指定的活动或者没有找到指定的活动属性。';

$_LANG['collect_goods'] = '收藏活动';
$_LANG['plus'] = '加';
$_LANG['minus'] = '减';
$_LANG['yes'] = '是';
$_LANG['no'] = '否';

$_LANG['same_attrbiute_goods'] = '相同%s的活动';

/* TAG */
$_LANG['button_submit_tag'] = '添加我的标记';
$_LANG['tag_exists'] = '您已经为该活动添加过一个标记，请不要重复提交.';
$_LANG['tag_cloud'] = '标签云';
$_LANG['tag_anonymous'] = '对不起，只有注册会员并且正常登录以后才能提交标记。';
$_LANG['tag_cloud_desc'] = '标签云（Tag cloud）是用以表示一个网站中的内容标签。 标签（tag、关键词）是一种更为灵活、有趣的活动分类方式，您可以为每个活动添加一个或多个标签，那么可以通过点击这个标签查看活动其他会员提交的与您的标签一样的活动,能够让您使用最快的方式查找某一个标签的所有网店活动。比方说点击“红色”这个标签，就可以打开这样的一个页面，显示所有的以“红色” 为标签的网店活动';

/* AJAX 相关 */
$_LANG['invalid_captcha'] = '对不起，您输入的验证码不正确。';
$_LANG['goods_exists'] = '对不起，您的购物车中已经存在相同的活动。';
$_LANG['fitting_goods_exists'] = '对不起，您的购物车中已经添加了该配件。';
$_LANG['invalid_number'] = '对不起，您输入了一个非法的活动数量。';
$_LANG['not_on_sale'] = '对不起，该活动已经下架。';
$_LANG['no_basic_goods'] = '对不起，您希望将该活动做为配件购买，可是购物车中还没有该活动的基本件。';
$_LANG['cannt_alone_sale'] = '对不起，该活动不能单独销售。';
$_LANG['shortage'] = "对不起，该活动已经库存不足暂停销售。\n你现在要进行缺货登记来预订该活动吗？";
$_LANG['shortage_little'] = "该活动已经库存不足。已将您的购货数量修改为 %d。\n您现在要去购物车吗？";
$_LANG['oos_tips'] = '该活动已经库存不足。您现在要进行缺货登记吗？';

$_LANG['addto_cart_success_1'] = "该活动已添加到购物车，您现在还需要继续购物吗？\n如果您希望马上结算，请点击“确定”按钮。\n如果您希望继续购物，请点击“取消”按钮。";
$_LANG['addto_cart_success_2'] = "该活动已添加到购物车，您现在还需要继续购物吗？\n如果您希望继续购物，请点击“确定”按钮。\n如果您希望马上结算，请点击“取消”按钮。";
...
$_LANG['comment_custom'] = '评论失败。只有在本店购买过活动的注册会员才能发表评论。';
$_LANG['comment_brought'] = '评论失败。只有购买过此活动的注册用户才能评论该活动。';
$_LANG['anonymous'] = '匿名用户';

/* 其他信息 */
$_LANG['js_languages']['goodsname_not_null'] = '活动名不能为空！';

/* 活动比较 */
$_LANG['compare_remove'] = '移除';
$_LANG['compare_no_goods'] = '您没有选定任何需要比较的活动或者比较的活动数少于 2 个。';
...
$_LANG['drop_consignee_confirm'] = '您确定要删除该个人信息吗？';
...
$_LANG['de'] = '的';
$_LANG['bonus'] = '红包';
$_LANG['goods_all_price'] = "活动总价";
$_LANG['discount'] = '折扣';
$_LANG['tax'] = '发票税额';
$_LANG['shipping_fee'] = '配送费用';
$_LANG['pack_fee'] = '包装费用';
$_LANG['card_fee'] = '贺卡费用';
$_LANG['total_fee'] = '应缴纳报名费';
$_LANG['self_site'] = '本站';
$_LANG['order_gift_integral'] = '订单 %s 赠送的积分';

$_LANG['order_payed_sms'] = '订单 %s 付款了。：%s；电话：%s。';

/* 缺货处理 */
$_LANG['oos'][OOS_WAIT] = '等待所有活动备齐后再发';
...
$_LANG['receive'] = '个人信息确认';
$_LANG['buyer'] = '买家';
$_LANG['next_article'] = '下一篇';
$_LANG['prev_article'] = '上一篇';

/* 虚拟活动 */
$_LANG['virtual_goods_ship_fail'] = '';
/*$_LANG['virtual_goods_ship_fail'] = '自动发货失败，请尽快联系系统重新发货';*/

/* 选购中心 */
$_LANG['pick_out'] = '选购中心';
$_LANG['fit_count'] = "共有 %s 件活动符合条件";
$_LANG['goods_type'] = "活动类型";
...
$_LANG['group_buy_goods'] = '团购活动';
$_LANG['gb_goods_name'] = '团购活动：';
...
$_LANG['gb_notice_login'] = '提示：您需要先注册成为本站会员并且登录后，才能参加活动团购!';
$_LANG['gb_error_goods_lacking'] = "对不起，活动库存不足，请您修改数量！";
...
$_LANG['au_bid_repeat_user'] = "您已经是这个活动的最高出价人了";
...
$_LANG['au_is_winner'] = '恭喜您，您已经赢得了该活动的购买权。请点击下面的购买按钮将您的宝贝买回家吧。';
...
$_LANG['wholesale'] = '批发';
$_LANG['no_wholesale'] = '没有批发活动';
$_LANG['ws_price'] = "批发价";
$_LANG['ws_subtotal'] = '小计';
$_LANG['ws_invalid_goods_number'] = '请输入正确的数量';
$_LANG['ws_attr_not_matching'] = "您选择的活动属性不存在，请参照批发价格单选择";
$_LANG['ws_goods_number_not_enough'] = "您购买的数量没有达到批发的最小数量，请参照批发价格单";
$_LANG['ws_goods_attr_exists'] = '该活动已经在购物车中，不能再次加入';
...
$_LANG['eg_error_status'] = '对不起，该活动已经取消，现在不能兑换！';
$_LANG['eg_error_integral'] = '对不起，您现有的积分值不够兑换本活动！';
$_LANG['notice_eg_integral'] = "积分商城活动需要消耗积分";
$_LANG['eg_error_number'] = "对不起，该活动库存不足，现在不能兑换！";
...
$_LANG['topic_goods_empty'] = '当前没有专题活动';
...
$_LANG['please_select_attr'] = '你加入购物车的活动有不同型号可选，你是否要立即跳转到活动详情选择型号？';
...
$_LANG['feed_goods_price'] = "活动价格";
$_LANG['feed_goods_desc'] = "活动描述";

/* 留言板 */
$_LANG['shopman_comment'] = '活动评论';
...
$_LANG['shop_owner_reply'] = '审核回复';
$_LANG['message_board_type'] = '留言类型';
$_LANG['message_content'] = '申请内容为空';
...
$_LANG['message_type'][M_BUSINESS] = '系统留言';
...
$_LANG['message_board_js']['msg_title_empty'] = '申请标题为空';
$_LANG['message_board_js']['msg_content_empty'] = '申请内容为空';
$_LANG['message_board_js']['msg_captcha_empty'] = '验证码为空';
$_LANG['message_board_js']['msg_title_limit'] = '申请标题为空不能超过200个字';
$_LANG['message_submit_wait'] = '您的留言已成功发表, 请等待管理员的审核!';
$_LANG['message_submit_done'] = '提交申请成功';
...
$_LANG['no_history'] = '您已清空最近浏览过的活动';
$_LANG['goods_tag'] = '活动标签';
$_LANG['releate_goods'] = '相关活动';
$_LANG['goods_list'] = '活动列表';
$_LANG['favourable_goods'] = '收藏该活动';
$_LANG['accessories_releate'] = '相关配件';
$_LANG['article_releate'] = '相关文章';
$_LANG['email_subscribe'] = '邮件订阅';
$_LANG['consignee_info'] = '个人信息';
$_LANG['user_comment'] = '用户评论';
$_LANG['total'] = '共';
$_LANG['user_comment_num'] = '条评论';
$_LANG['auction_goods'] = '拍卖活动';
$_LANG['auction_goods_info'] = '拍卖活动详情';
...
$_LANG['wholesale_goods_cart'] = '批发活动购物车';
$_LANG['wholesale_goods_list'] = '批发活动列表';
$_LANG['bid_record'] = "出价记录";
$_LANG['shipping_method'] = '配送方式';
$_LANG['payment_method'] = '支付方式';
$_LANG['goods_package'] = '活动包装';
$_LANG['goods_card'] = '祝福贺卡';
$_LANG['groupbuy_intro'] = '团购说明';
$_LANG['groupbuy_goods_info'] = '团购活动详情';
$_LANG['act_time'] = '起止时间';
$_LANG['top10'] = '销售排行';
...
/*修改 start by zhouH*/
$_LANG['err_no_goodsId'] = '缺少参数：活动ID，无法获取活动信息数据';
$_LANG['quick_shop_pirce'] = "报名费：%s";
