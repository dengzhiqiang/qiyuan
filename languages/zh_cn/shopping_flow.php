...
$_LANG['goods_not_exists'] = '对不起，指定的活动不存在';
$_LANG['drop_goods_confirm'] = '您确实要把该活动移出活动里列表吗？';
$_LANG['goods_number_not_int'] = '请您输入正确的活动数量。';
$_LANG['stock_insufficiency'] = '非常抱歉，您选择的活动 %s 的库存数量只有 %d，您最多只能购买 %d 件。';
$_LANG['package_stock_insufficiency'] = '非常抱歉，您选择的超值礼包数量已经超出库存。请您减少购买量或联系系统。';
...
$_LANG['no_goods_in_cart'] = '您的购物车中没有活动！';
$_LANG['not_submit_order'] = '您参与本次团购活动的订单已提交，请勿重复操作！';
...
$_LANG['goods_fittings'] = '活动相关配件';
$_LANG['parent_name'] = '相关活动：';
...
/* 个人信息 */
$_LANG['flow_js']['consignee_not_null'] = '姓名不能为空！';
$_LANG['flow_js']['country_not_null'] = '请您选择所在国家！';
$_LANG['flow_js']['province_not_null'] = '请您选择所在省份！';
$_LANG['flow_js']['city_not_null'] = '请您选择所在城市！';
$_LANG['flow_js']['district_not_null'] = '请您选择所在区域！';
$_LANG['flow_js']['invalid_email'] = '您输入的邮件地址不是一个合法的邮件地址。';
$_LANG['flow_js']['address_not_null'] = '的详细地址不能为空！';
...
$_LANG['new_consignee_address'] = '新个人信息';
$_LANG['consignee_address'] = '个人信息';
...
$_LANG['city'] = '城市';
$_LANG['area'] = '所在区域';
$_LANG['consignee_add'] = '添加新个人信息';
$_LANG['shipping_address'] = '配送至这个地址';
$_LANG['address_amount'] = '您的个人信息最多只能是三个';
$_LANG['not_fount_consignee'] = '对不起，您选定的个人信息不存在。';

/*------------------------------------------------------ */
//-- 订单提交
/*------------------------------------------------------ */

$_LANG['goods_amount_not_enough'] = '您购买的活动没有达到本店的最低限购金额 %s ，不能提交订单。';
$_LANG['balance_not_enough'] = '您的余额不足以支付整个订单，请选择其他支付方式';
$_LANG['select_shipping'] = '您选定的配送方式为';
$_LANG['select_payment'] = '您选定的支付方式为';
$_LANG['order_amount'] = '您的应缴纳报名费为';
...
$_LANG['order_placed_sms'] = "您有新订单.:%s 电话:%s";
$_LANG['sms_paid'] = '已付款';
...
$_LANG['bonus_min_amount_error'] = '订单活动金额没有达到使用该红包的最低金额 %s';
