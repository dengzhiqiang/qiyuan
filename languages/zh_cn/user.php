...
$_LANG['label_order'] = '我的报名';
$_LANG['label_address'] = '个人信息';
...
$_LANG['booking_goods_name'] = '订购活动名';
...
$_LANG['booking_success'] = '您的活动订购已经成功提交！';
$_LANG['booking_rec_exist'] = '此活动您已经进行过缺货登记了！';
$_LANG['back_booking_list'] = '返回缺货登记列表';
$_LANG['not_dispose'] = '未处理';
$_LANG['no_goods_id'] = '请指定活动ID';

//JS语言项
$_LANG['booking_js']['booking_amount_empty'] = '请输入您要订购的活动数量！';
...
$_LANG['del_address_false'] = '删除个人信息失败！';
$_LANG['add_address_success'] = '添加新地址成功！';
$_LANG['edit_address_success'] = '您的个人信息信息已成功更新！';
$_LANG['address_list_lnk'] = '返回地址列表';
$_LANG['add_address'] = '保存个人信息';
$_LANG['confirm_edit'] = '确认修改';

$_LANG['confirm_drop_address'] = '你确认要删除该个人信息吗？';
...
$_LANG['type'][M_BUY] = '求购';
$_LANG['type'][M_BUSINESS] = '系统留言';

$_LANG['add_message_success'] = '提交申请成功';
$_LANG['message_list_lnk'] = '返回留言列表';
$_LANG['msg_title_empty'] = '申请标题为空';
...
$_LANG['merge_order_notice'] = '订单合并是在发货前将相同状态的订单合并成一新的订单。<br />个人信息，送货方式等以主定单为准。';
...
$_LANG['business_message'] = '发送/查看系统留言';
...
$_LANG['ss'][SS_RECEIVED] = '个人信息确认';
$_LANG['ss'][SS_SHIPPED_PART] = '已发货(部分活动)';
...
$_LANG['del_attention'] = '确认取消此活动的关注么？';
$_LANG['add_to_attention'] = '确定将此活动加入关注列表么？';
$_LANG['label_need_image'] = '是否显示活动图片：';
$_LANG['need'] = '显示';
$_LANG['need_not'] = '不显示';
$_LANG['horizontal'] = '横排';
$_LANG['verticle'] = '竖排';
$_LANG['generate'] = '生成代码';
$_LANG['label_goods_num'] = '显示活动数量：';
$_LANG['label_rows_num'] = '排列显示条目数：';
$_LANG['label_arrange'] = '选择活动排列方式：';
$_LANG['label_charset'] = '选择编码：';
$_LANG['charset']['utf8'] = '国际化编码（utf8）';
$_LANG['charset']['zh_cn'] = '简体中文';
$_LANG['charset']['zh_tw'] = '繁体中文';
$_LANG['goods_num_must_be_int'] = '活动数量应该是整数';
$_LANG['goods_num_must_over_0'] = '活动数量应该大于0';
...
$_LANG['clips_js']['msg_title_empty'] = '申请标题为空';
$_LANG['clips_js']['msg_content_empty'] = '申请内容为空';
$_LANG['clips_js']['msg_title_limit'] = '申请标题为空不能超过200个字';
...
$_LANG['return_to_cart_success'] = '订单中活动已经成功加入购物车中';

/* 保存用户订单个人信息 */
$_LANG['consigness_empty'] = '姓名为空';
$_LANG['address_empty'] = '个人信息详情为空';
...
　　１、在浏览活动时，点击推荐此活动，获得推荐代码，将其发送到论坛、博客上。
　　２、访问者点击链接，访问网店。
...
$_LANG['user_reg_info'][2] = '不注册为会员也可在本店购买活动';
$_LANG['user_reg_info'][8] = '不注册为会员不可以在本店购买活动';
$_LANG['user_reg_info'][3] = '但注册之后您可以';
$_LANG['user_reg_info'][4] = '保存您的个人资料';
$_LANG['user_reg_info'][5] = '收藏您关注的活动';
$_LANG['user_reg_info'][6] = '享受会员积分制度';
$_LANG['user_reg_info'][7] = '订阅本店活动信息';
