...
<div id="header-div">
  ...
  <div id="submenu-div">
    <ul>
        <li><a href="index.php?act=clear_cache" target="main-frame" class="fix-submenu"><img src="images/qingchu.png" style="border:none;"><span>清除缓存</span></a></li>
...
<div id="menu-div">
  <ul>
    ...
    <li><a href="goods.php?act=list" target="main-frame"><img src="images/index-11_09.png" width="17" height="18" align="absmiddle"/><span>活动管理</span><span class="num"><?php echo $this->_var['goods_sum']; ?></span></a><span class="muneFG"></span></li>
