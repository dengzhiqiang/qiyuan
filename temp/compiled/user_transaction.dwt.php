...
?>
        ...
        <?php endif; ?>
         ...
         <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
          <tr>
            <th width="23%" align="center" bgcolor="#ffffff">活动名称</th>
            <th width="29%" align="center" bgcolor="#ffffff"><?php echo $this->_var['lang']['goods_attr']; ?></th>
            <!--<th><?php echo $this->_var['lang']['market_price']; ?></th>-->
            <th width="26%" align="center" bgcolor="#ffffff">活动价格<?php if ($this->_var['order']['extension_code'] == "group_buy"): ?><?php echo $this->_var['lang']['gb_deposit']; ?><?php endif; ?></th>
...
?>
          ...
          <tr>
            ...
            活动价格：<?php if ($this->_var['order']['extension_code'] == "group_buy"): ?><?php echo $this->_var['lang']['gb_deposit']; ?><?php endif; ?>: <?php echo $this->_var['order']['formated_goods_amount']; ?>
            </td>
          </tr>
        </table>
        <h1>费用总计</h1>
        ...
        <h1>我的信息</h1>
         <?php if ($this->_var['order']['allow_update_address'] > 0): ?>
          <form action="user.php" method="post" name="formAddress" id="formAddress">
           <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
              <tr>
                <td width="15%" align="right" bgcolor="#ffffff">报名人姓名： </td>
                ...
                <td width="15%" align="right" bgcolor="#ffffff">报名人邮件： </td>
...
?>
          ...
          <button id="print_button" style="color:#fff;border:none;background: none;width:100px;height:34px;text-align: center;line-height: 34px;background: #f70;">打印报名表</button>


        <h1 style="display:none;">其他信息</h1>
        <table style="display:none;" width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
...
?>
            <form action="user.php" class="theFormDeng" method="post" name="theForm" onsubmit="return checkConsignee(this)">
              <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                <tr>
                  <td align="right" bgcolor="#ffffff">现住区域</td>
                  <td colspan="3" align="left" bgcolor="#ffffff">
...
?>
                ...
                <tr>
                  <td style="width:74px;" align="right" bgcolor="#ffffff">报名人姓名：</td>
                  <td style="width:250px;" align="left" bgcolor="#ffffff"><input name="consignee" type="text" class="inputBg" id="consignee_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['consignee']); ?>" />
                  <?php echo $this->_var['lang']['require_field']; ?> </td>
                  <td style="width:74px;"  align="right" bgcolor="#ffffff">邮件：</td>
                  <td style="width:250px;"  align="left" bgcolor="#ffffff"><input name="email" type="text" class="inputBg" id="email_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['email']); ?>" />
                  <?php echo $this->_var['lang']['require_field']; ?></td>
                </tr>
                <tr>
                  <td align="right" bgcolor="#ffffff">通讯地址：</td>
                ...
                <tr>
                  <td align="right" bgcolor="#ffffff">预报组别：</td>
                  ...
                  <td align="right" bgcolor="#ffffff">段位证书号：</td>
              ...
              <tr>
                  ...
                  <td align="left" bgcolor="#ffffff"><input name="ageDeng" type="text" class="inputBg" id="ageDeng_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['sign_building']); ?>" /></td>
                  <td align="right" bgcolor="#ffffff">陪同人数：</td>
                  <td align="left" bgcolor="#ffffff"><input name="renshuDeng" type="text"  class="inputBg" id="renshuDeng_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['best_time']); ?>" /></td>
              </tr>
              <tr>
                  <td align="right" bgcolor="#ffffff">报名单位：</td>
                  <td align="left" bgcolor="#ffffff"><input name="baomingdanweiDeng" type="text" class="inputBg" id="baomingdanweiDeng_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['sign_building']); ?>" /></td>
                  <td align="right" bgcolor="#ffffff">上传附件：</td>
                  <td align="left" bgcolor="#ffffff"><input type="file" name="fujianDeng_<?php echo $this->_var['sn']; ?>" id=""> <br>上传的格式为jpg,jpeg,png，图片最大为500kb</td>
              </tr>
              ...
              <tr>
                  ...
                  <td colspan="3" align="center" bgcolor="#ffffff"><?php if ($this->_var['consignee']['consignee'] && $this->_var['consignee']['email']): ?>
                    ...
                    <input style="display:none;" name="button" type="button" class="btn btn-primary"  onclick="if (confirm('<?php echo $this->_var['lang']['confirm_drop_address']; ?>'))location.href='user.php?act=drop_consignee&id=<?php echo $this->_var['consignee']['address_id']; ?>'" value="<?php echo $this->_var['lang']['drop']; ?>" />
                    <?php else: ?>
...
<script>
    $("#print_button").click(function(){
        $(".my_nala_centre.ilizi_centre").printArea();
    });
</script>
